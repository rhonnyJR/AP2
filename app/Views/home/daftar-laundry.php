...
<head>
    ...
    <title>KOMAHA - DAFTAR LAUNDRY</title>
                        ...
                        ?>
                            <div class="col-xl-4 col-md-6 portfolio-item">
                                <div class="portfolio-wrap">
                                    <a href="<?= base_url(); ?>/assets/foto/laundry_image.jpg" data-gallery="portfolio-gallery-app" class="glightbox"><img src="<?= base_url(); ?>/assets/foto/laundry_image.jpg" class="img-fluid" alt=""></a>
                                    <div class="portfolio-info">
                                        <h4><a href="<?= route_to('detail-laundry', $val['ID_LAUNDRY']) ?>" title="More Details"><?= $val['NAMA_PAKET'] ?></a></h4>
                                        <p>
                                            <i class="bi bi-droplet-half flex-shrink-0"></i>&nbsp; <?= implode(", ", $ARR_FASILITAS) ?><br>
                                            <i class="bi bi-coin flex-shrink-0"></i><span>&nbsp; <?= "Rp " . number_format($val['HARGA'], 2, ',', '.') ?></span>
                                        </p>
                                    </div>
                                </div>
