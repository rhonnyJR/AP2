                            ...
                            <td class="text-center">
                                ...
                                ?>
                                    <a class="btn btn-primary btn-action btn-acc" data-toggle="tooltip" data-original-title="Konfirmasi">
                                        <form action="<?= route_to('tr-laundry-update-status-admin', $data['ID_TRANSAKSI']); ?>" method="POST" id="konfirmasi" class="">
                                            <?= csrf_field(); ?>
                                ...
                                ?>
                                    <a class="btn btn-danger btn-action btn-rej" data-toggle="tooltip" data-original-title="Tolak">
                                        <form action="<?= route_to('tr-laundry-update-status-admin', $data['ID_TRANSAKSI']); ?>" method="POST" id="tolak" class="">
                                            <?= csrf_field(); ?>
                                            <input type="hidden" name="_method" value="PUT" />
