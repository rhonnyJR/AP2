...
<div class="card card-primary">
    ...
    <div class="card-body">
        <form method="POST" action="<?= route_to('laundry-store-admin'); ?>" class="needs-validation form-simpan" novalidate="" enctype="multipart/form-data">
            <?= csrf_field(); ?>

            <div class="form-row">
                <div class="form-group col-md-9">
                    <label for="nama-paket">Nama Paket</label>
                    <input type="text" class="form-control" id="nama-paket" name="NAMA_PAKET" placeholder="Masukkan Nama Paket" onkeyup="this.value = this.value.toUpperCase()" required>
                </div>
